...
/* What to do when the server responds that someone joined our room */
...
/*2ND PART */
/* What to do when the server responds that someone has left our room */
...
function makeInviteButton(socket_id){
	var newHTML = '<button type=\'button\' class=\'btn btn-outine-primary\'>Invite</button>';
	var newNode = $(newHTML);
