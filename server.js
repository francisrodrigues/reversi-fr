...
*/
	socket.on('join_room', function(payload){
		...
		/* Check that the client sent a paylod */
		...
		/* Check that the paylod has a room to join */
...
*/
	...
	{
		'result' : 'success',
		'socket_id' : the socket id of the person doing unviting
	}
	or
	{
		'result' : 'fail',
